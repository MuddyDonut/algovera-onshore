...
import GradCap from "images/graduate-cap-svgrepo-com.svg";
...
export default ({ cards = null, heading = "Amazing Features", subheading = "Features", description = "Providing you with the knowledge needed to engage in an ecosystem that rewards data enthusiast." }) => {
  ...
  const defaultCards = [
    ...
    },
    {
      ...
      title: "Blogs",
      description: "Hear from different curators and learn from their experiances."
    },
    ...
    { imageSrc:  FastIconImage, 
      title: "Easy",
      description: "Readily avaliable information and links to documentation."
    },
